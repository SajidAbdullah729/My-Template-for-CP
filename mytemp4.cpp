...
#define deb2(x,y)  std::cout << #x << " = " << x << std::endl; std::cout << #y << " = " << y << std::endl;
#define deb3(x,y,z) std::cout << #x << " = " << x << std::endl; std::cout << #y << " = " << y << std::endl; std::cout << #z << " = " << z << std::endl;
#define deb4(x,y,z,r) std::cout << #x << " = " << x << std::endl; std::cout << #y << " = " << y << std::endl; std::cout << #z << " = " << z << std::endl;std::cout << #r << " = " << r << std::endl;
